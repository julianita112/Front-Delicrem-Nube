...
export function Compras() {
  ...
  const fetchCompras = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/compras");
  ...
  const handleCancelCompra = async () => {
    ...
    try {
      ...
      await axios.patch(`https://backenddelicremfinal.onrender.com/api/compras/${compraToCancel}/estado`, { 
        id_estado: 5, 
