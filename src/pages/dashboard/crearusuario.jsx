...
const debounceValidate = debounce(async (user) => {
  ...
  const checkUserExists = async (field, value) => {
    try {
        const response = await axios.get(`https://backenddelicremfinal.onrender.com/api/usuarios`); // Consulta toda la tabla
  ...
  const handleSave = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(
          `https://backenddelicremfinal.onrender.com/api/usuarios/${selectedUser.id_usuario}`,
          selectedUser
        );
        fetchUsuarios();
        Toast.fire({
        ...
        await axios.post("https://backenddelicremfinal.onrender.com/api/usuarios/registro", selectedUser);
        fetchUsuarios();
        Toast.fire({
          icon: "success",
