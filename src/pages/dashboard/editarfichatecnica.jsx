...
const fetchExistingInsumos = async () => {
  try {
    const response = await axios.get("https://backenddelicremfinal.onrender.com/api/insumos"); // Asegúrate de que esta URL es correcta
  ...
  const handleSave = async () => {
    ...
    try {
      await axios.put(`https://backenddelicremfinal.onrender.com/api/fichastecnicas/${selectedFicha.id_ficha}`, fichaToSave);
      Toast.fire({
        icon: 'success',
