...
export function OrdenesProduccion() {
  ...
  const fetchOrdenes = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/ordenesproduccion");
  ...
  const handleProducir = async (idOrden) => {
    try {
      await axios.post(`https://backenddelicremfinal.onrender.com/api/ordenesproduccion/${idOrden}/producir`);
      Toast.fire({
        icon: 'success',
  ...
  const handleConfirmAnulacion = async () => {
    ...
    try {
      await axios.patch(`https://backenddelicremfinal.onrender.com/api/ordenesproduccion/${ordenToAnular.id_orden}/estado`, {
