...
export function Ventas() {
  ...
  const handleEntregarVenta = async (numero_venta) => {
    ...
    try {
      const response = await axios.patch(`https://backenddelicremfinal.onrender.com/api/ventas/${numero_venta}/entregar`);
  ...
  const fetchClientes = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/clientes");
  ...
  const fetchPedidos = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/pedidos");
  ...
  const fetchEstados = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/estados");
  ...
  const handleCancelVenta = async () => {
    ...
    try {
      await axios.patch(`https://backenddelicremfinal.onrender.com/api/ventas/${ventaToCancel}/estado`, { 
