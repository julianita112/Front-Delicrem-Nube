...
export function Pedidos() {
  ...
  const handleUpdateEstado = async () => {
    try {
      const response = await axios.put(`https://backenddelicremfinal.onrender.com/api/pedidos/${selectedPedido.numero_pedido}/estado`, { estado: selectedEstado });
  ...
  const handleCancelPedido = async () => {
    ...
    try {
      await axios.patch(`https://backenddelicremfinal.onrender.com/api/pedidos/${pedidoToCancel}/estado`, {
        id_estado: 5, // Anulado
