...
export function Usuarios() {
  ...
  const handleDelete = async (user) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backenddelicremfinal.onrender.com/api/usuarios/${user.id_usuario}`);
        fetchUsuarios();
        Toast.fire({
          icon: "success",
  ...
  const toggleActivo = async (id_usuario, estado) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        await axios.patch(`https://backenddelicremfinal.onrender.com/api/usuarios/${id_usuario}/estado`, { estado: !estado });
        fetchUsuarios();
        Toast.fire({
          icon: 'success',
