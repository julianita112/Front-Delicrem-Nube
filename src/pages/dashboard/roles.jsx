...
export function Roles() {
  ...
  const fetchRoles = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/roles");
  ...
  const fetchPermisos = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/permisos");
  ...
  const handleDelete = async (role) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backenddelicremfinal.onrender.com/api/roles/${role.id_rol}`);
        fetchRoles(); 
        Toast.fire({
          icon: "Rol Eliminado",
  ...
  const handleSave = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(`https://backenddelicremfinal.onrender.com/api/roles/${selectedRole.id_rol}`, {
        ...
        await axios.post("https://backenddelicremfinal.onrender.com/api/roles", {
          nombre: selectedRole.nombre,
          permisos: selectedRole.permisosRol,
          estado: selectedRole.estado,
        });
  ...
  const toggleActivo = async (id_rol, estado) => {
    ...
    if (result.isConfirmed) {
      try {
        if (estado) { 
          const response = await axios.get(`https://backenddelicremfinal.onrender.com/api/usuarios`);
        ...
        await axios.patch(`https://backenddelicremfinal.onrender.com/api/roles/${id_rol}/estado`, { estado: !estado });
        fetchRoles();
        Toast.fire({
          icon: 'success',
