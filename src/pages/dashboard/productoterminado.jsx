...
export function ProductoTerminado() {
  ...
  const fetchProductos = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/productos");
  ...
  const fetchProductosActivos = async () => {
    try {
      const response = await axios.get("https://backenddelicremfinal.onrender.com/api/productos/activos");
  ...
  const handleSave = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(`https://backenddelicremfinal.onrender.com/api/productos/${selectedProducto.id_producto}`, selectedProducto);
        Toast.fire({
          icon: 'success',
          title: 'El producto ha sido actualizado correctamente.'
        });
      } else {
        await axios.post("https://backenddelicremfinal.onrender.com/api/productos", selectedProducto);
        Toast.fire({
          icon: 'success',
  ...
  const handleDelete = async (producto) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backenddelicremfinal.onrender.com/api/productos/${producto.id_producto}`);
        fetchProductos();
        Toast.fire({
          icon: 'success',
  ...
  const toggleActivo = async (id_producto, estado) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const ordenesResponse = await axios.get(`https://backenddelicremfinal.onrender.com/api/ordenesProduccion`);
        ...
        const ventasResponse = await axios.get(`https://backenddelicremfinal.onrender.com/api/ventas`);
        ...
        await axios.patch(`https://backenddelicremfinal.onrender.com/api/productos/${id_producto}/estado`, { estado: !estado });
        fetchProductos();
        fetchProductosActivos();
        const Toast = Swal.mixin({
          toast: true,
